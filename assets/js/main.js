...
function initBattery() {
  ...
  navigator.getBattery().then((batt) => {
    updateBattery = () => {
      ...
      /* We validate full battery, low battery and if it is charging or not */

      if (level == 100) {
        /* validate if battery full */
        ...
        /* we balidate if the battery is charging */
        batteryStatus.innerHTML = `Charging... <i class="ri-flashlight-line animated-green"></i>`;
      } else {
        /* if not loading , dont show anything. */
        batteryStatus.innerHTML = ``;
      }

      /* We change the colors of the battery and remove the other colors */
